          ...
          try {
            ...
            if (
              ...
              if (signInMethods.includes("google.com")) {
                errorMessage =
                  "This email is registered with Google Sign-In. Please use the 'Continue with Google' button instead.";
              } else {
                errorMessage = `This email is registered with a different sign-in method. Please use the correct sign-in method.`;
              }
            } else {
              errorMessage = getFirebaseErrorMessage(error);
            }
          } catch {
            // If we can't fetch sign-in methods, just show the default error
            errorMessage = getFirebaseErrorMessage(error);
          }
        } else {
          errorMessage = getFirebaseErrorMessage(error);
